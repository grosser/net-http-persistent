Gem::Specification.new 'net-http-persistent-retry', '3.0.1' do |s|
  s.summary = "Manages persistent connections using Net::HTTP ... without retries"
  ...
  s.homepage = "https://github.com/grosser/net-http-persistent"
